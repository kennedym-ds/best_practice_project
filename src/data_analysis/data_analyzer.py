...
class DataAnalyzer:
    ...
    def get_summary_statistics(self) -> pd.DataFrame:
        ...
        additional_stats = pd.DataFrame(
            {"skewness": self.df[numeric_cols].skew(), "kurtosis": self.df[numeric_cols].kurtosis()}
        ).T
    ...
    def get_correlation_matrix(
        self, method: str = "pearson", columns: Optional[List[str]] = None
    ) -> pd.DataFrame:
        """
    ...
    def group_analysis(
        self, group_by: str, agg_column: str, agg_func: str = "mean"
    ) -> pd.DataFrame:
        """
    ...
    def simple_linear_regression(self, x_column: str, y_column: str) -> Dict[str, float]:
        """
    ...
    def get_value_counts(
        self, column: str, normalize: bool = False, top_n: Optional[int] = None
    ) -> pd.Series:
        """
