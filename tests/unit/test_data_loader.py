...
class TestDataLoaderInitialization:
    ...
    def test_init_creates_directory(self, temp_data_dir):
        ...
        _ = DataLoader(data_dir=str(new_dir))
...
class TestDataLoaderCSV:
    ...
    @pytest.mark.skip(
        reason=(
            "pandas is very forgiving with CSV parsing and may not raise "
            "exceptions for malformed data"
        )
    )
...
class TestDataLoaderIntegration:
    ...
    def test_load_save_roundtrip(self, sample_data, temp_data_dir):
        ...
        _ = loader.save_csv(sample_data, "roundtrip.csv", output_dir=str(temp_data_dir))
