...
class TestHistogram:
    ...
    def test_create_histogram_save(self, sample_data, temp_output_dir):
        ...
        fig = viz.create_histogram('age', save_path=save_path)
...
class TestBoxplot:
    ...
    def test_create_boxplot_save(self, sample_data, temp_output_dir):
        ...
        fig = viz.create_boxplot('salary', save_path=save_path)
...
class TestScatterPlot:
    ...
    def test_create_scatter_save(self, sample_data, temp_output_dir):
        ...
        fig = viz.create_scatter('age', 'salary', save_path=save_path)
...
class TestCorrelationHeatmap:
    ...
    def test_create_correlation_heatmap_save(self, sample_data, temp_output_dir):
        ...
        fig = viz.create_correlation_heatmap(save_path=save_path)
...
class TestLinePlot:
    ...
    def test_create_line_plot_save(self, sample_data, temp_output_dir):
        ...
        fig = viz.create_line_plot('age', ['salary'], save_path=save_path)
...
class TestBarPlot:
    ...
    def test_create_bar_plot_save(self, sample_data, temp_output_dir):
        ...
        fig = viz.create_bar_plot('department', 'salary', save_path=save_path)
...
class TestCountplot:
    ...
    def test_create_countplot_save(self, sample_data, temp_output_dir):
        ...
        fig = viz.create_countplot('department', save_path=save_path)
